$(function() {
	...
	$("#btn_upload_course_img").change(function() {
		uploadImg($(this), $("#course_img_patch"), $("#course_img"));
	});

	$("#btn_upload_member_photo").change(function() {
		uploadImg($(this), $("#member_photo_patch"), $("#member_photo"));
	});
		...
		$(".btn-edit-course").click(function() {
			$.ajax({
				...
				success: function(response) {
					...
					$("#course_img_patch").attr("src", response["img"]["course_img"]);
    ...
    new $.fn.dataTable.FixedHeader(dt_course);
		...
		$(".btn-edit-member").click(function() {
			$.ajax({
				...
				success: function(response) {
					...
					$("#member_photo_patch").attr("src", response["img"]["member_photo"]);
	...
	var dt_member = $("#dt_team").DataTable({
 	...
 	new $.fn.dataTable.FixedHeader(dt_member);
    ...
    new $.fn.dataTable.FixedHeader(dt_user);
})
