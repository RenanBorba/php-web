...
<html lang="en">
	<head>
		...
		<title>IdeiaCursos Treinamentos</title>
		<!-- Bootstrap core CSS -->
		...
		<nav class="navbar navbar-default navbar-shrink navbar-fixed-top">
			<div class="container">
				...
				<div class="navbar-header page-scroll">
					...
					<a class="navbar-brand page-scroll" href="<?php echo base_url(); ?>#page-top"><img src="<?php echo base_url(); ?>public/images/logo.png" alt="Logotipo"></a>
				</div>
