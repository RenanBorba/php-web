<section style="min-height: calc(100.05vh - 83px);" class="light-bg"> 
	<div class="container center-block">
		<div class="row">
			<div class="col-lg-offset-3 col-lg-6 text-center">
				<div class="section-title">
					<h2 class="text-center center-block">ÁREA RESTRITA</h2>
				</div>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-lg-offset-5 col-lg-2 text-center">
				<div class="form-group">
					<a id="btn_your_user" class="btn btn-success" user_id="<?=$user_id?>">
						<i class="fa fa-user"></i></a>
					<a class="btn btn-success" href="restrict/logoff"><i class="fa fa-sign-out"></i></a>
				</div>
			</div>
		</div>
			...
			<div class="tab-content">
				<div id="tab_courses" class="tab-pane active">
					<div class="container-fluid">
						<h2 class="text-center center-block"><strong>GERENCIAR CURSOS</strong></h2>
						<a id="btn_add_course" class="btn btn-success"><i class="fa fa-plus"></i></a>
						<br><br>
						<table id="dt_courses" class="table table-responsive 
							table-striped table-bordered" style="width:100%;">
							<thead>
								<tr class="tableheader">
									<th class="dt-center">Nome</th>
									<th class="img-responsive center-block dt-center no-sort">Imagem</th>
				...
				<div id="tab_team" class="tab-pane">
					<div class="container-fluid">
						<h2 class="text-center center-block"><strong>GERENCIAR EQUIPE</strong></h2>
						<a id="btn_add_member" class="btn btn-success"><i class="fa fa-plus"></i></a>
						<br><br>
						<table id="dt_team" class="table table-responsive 
							table-striped table-bordered" style="width:100%">
							<thead>
								<tr class="tableheader">
									<th class="dt-center">Nome</th>
									<th class="img-responsive center-block dt-center no-sort">Foto</th>
									<th class="no-sort">Descrição</th>
									<th class="dt-center no-sort">Ações</th>
								</tr>
							</thead>
				...
				<div id="tab_user" class="tab-pane">
					<div class="container-fluid">
						<h2 class="text-center center-block"><strong>GERENCIAR USUÁRIOS</strong></h2>
						<a id="btn_add_user" class="btn btn-success"><i class="fa fa-plus"></i></a>
						<br><br>
						<table id="dt_users" class="table table-responsive 
							table-striped table-bordered" style="width:100%">
							<thead>
								<tr class="tableheader">
			...
			<div class="modal-body">
				<form id="form_course">
					...
					<div class="form-group">
						...
						<div class="col-lg-10">
							<img id="course_img_patch" class="img-responsive center-block" src="" 
							style="max-height: 275px; max-height: 275px">
							<label class="btn btn-block btn-success" 
							style="margin-top: 1px; margin-bottom: 1.5px">
								<i class="fa fa-upload"></i>&nbsp;&nbsp;Importar Imagem
								<input type="file" id="btn_upload_course_img" accept="image/*" 
									style="display: none;">
							</label>
					...
					<div class="form-group text-center">
						<button type="submit" id="btn_save_course" class="btn btn-success">
			...
			<div class="modal-body">
				<form id="form_member">
					...
					<div class="form-group">
						...
						<div class="col-lg-10">
							<img id="member_photo_patch" class="img-responsive center-block" src="" 
							style="max-height: 275px; max-height: 275px">
							<label class="btn btn-block btn-success" 
							style="margin-top: 1px; margin-bottom: 1.5px">
								<i class="fa fa-upload"></i>&nbsp;&nbsp;Importar Foto
								<input type="file" id="btn_upload_member_photo" accept="image/*" 
									style="display: none;">
							</label>
					...
					<div class="form-group text-center">
						<button type="submit" id="btn_save_member" class="btn btn-success">
							<i class="fa fa-save"></i>&nbsp;&nbsp;Salvar
						</button>
						<span class="help-block"></span>
					</div>
			...
			<div class="modal-body">
				<form id="form_user">
					...
					<div class="form-group">
						...
						<div class="col-lg-10">
							<input id="user_full_name" name="user_full_name" class="form-control" 
								maxlength="100">
							<span class="help-block"></span>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-lg-10">
							<input id="user_email_confirm" name="user_email_confirm" 
					...
					<div class="form-group text-center">
						<button type="submit" id="btn_save_user" class="btn btn-success">
							<i class="fa fa-save"></i>&nbsp;&nbsp;Salvar
						</button>
						<span class="help-block"></span>
					</div>
