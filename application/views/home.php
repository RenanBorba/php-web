			...
			<div class="container">
				<div class="slider-container">
					<div class="intro-text center-block">
						...
						<div class="intro-heading">IdeiaCursos</div>
				...
				<div class="row">
					...
					if (!empty($courses)) {
						foreach ($courses as $course) { ?>
									...
									<figure class="effect-bubba">
										...
										<figcaption>
											<a href="#" data-toggle="modal" 
												data-target="#course_<?=$course["course_id"]?>"></a>
										</figcaption>
									</figure>
								</div>
							</div>
							...
							<!-- modal for course -->
							<div class="modal fade" id="course_<?=$course["course_id"]?>" tabindex="-1" role="dialog"
								...
								<div class="modal-dialog" role="document">
									<div class="modal-content">
										...
										<div class="modal-body">
											<img src="<?=base_url().$course["course_img"]?>" alt="course" class="img-responsive center-block"/>
											<div class="modal-works"><span>Duração: 
												<?=intval($course["course_duration"])?> (h)
											</span></div><p><?=$course["course_description"]?></p>
										</div>
				...
				<div class="row">
					...
					if (!empty($team)) {
						foreach ($team as $member) { ?>
							<div class="col-md-3">
								<div class="team-item" id="member_<?=$member["member_id"]?>">
									<div class="team-image">
										<img src="<?=base_url().$member["member_photo"]?>" class="img-responsive center-block" alt="member">
									</div>
									<div class="team-text">
